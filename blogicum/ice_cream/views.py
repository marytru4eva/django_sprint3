...
#def ice_cream_list(request):
    # Получаем все опубликованные сорта мороженого
    #ice_creams = IceCream.objects.filter(is_published=True)
    # Передаём в шаблон
    #return render(request, 'ice_cream/list.html', {'ice_creams': ice_creams})
